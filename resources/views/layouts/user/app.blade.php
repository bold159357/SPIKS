...
<head>
    ...
    <meta name="keywords" content="Sistem Pakar, Forward Chaining, Keprobadian">
    <meta name="description"
        content="Sistem pakar untuk mendeteksi kepribadian dengan algoritma forward chaining">

    <link rel="icon" href="{{ asset('spiks.ico') }}">
    <title>@yield('title') SPIKS</title>
...
<body class="bg-light-subtle">
    ...
    <script src="https://cdn.jsdelivr.net/npm/notyf@3/notyf.min.js"></script>z
